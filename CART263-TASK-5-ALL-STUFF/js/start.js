...
function go_all_stuff() {
    ...
    drawingBoardA.addObj(new CircularObj(0, 0, 20, "#FFC300", "#E6E6FA", drawingBoardA.context, drawingBoardA, Math.ceil(Math.random() * 400), Math.ceil(Math.random() * 300)))
    ...
    drawingBoardB.addObj(new RectangularObj(200, 150, 50, 70, "#FF5733", "#E6E6FA", drawingBoardB.context))
